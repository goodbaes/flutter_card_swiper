...
class _CardSwiperState<T extends Widget> extends State<CardSwiper>
  ...
  late final AnimationController _newCardAnimationController;
  ...
  void dispose() {
    ...
    _newCardAnimationController.dispose();
  ...
  Widget _backItem(BoxConstraints constraints, int index) {
    final isLastCard = index == numberOfCardsOnScreen() - 1;
  ...
  Future<void> _handleCompleteSwipe() async {
    ...
    _newCardAnimationController.forward(from: 0);
